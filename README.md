...
- **Core Value**: 화려한 로직보다 '멈추지 않는 시스템'의 가치를 믿습니다. 1,000번의 알고리즘 해결 과정에서 얻은 결벽증에 가까운 검증 습관으로 무결성 소프트웨어를 지향합니다.
...
- **숭실대학교**: 소프트웨어 학부 학사 졸업 (2019.03 ~ 2026.02)
- **Team-BackStreet**: 인디 게임 개발 팀장 (2022.11 ~ 2026.02)
